-- Evita falha em UPDATE/INSERT quando operational_notifications ou webhook_delivery_logs
-- ainda não existem (migrations parciais ou ordem diferente no remoto).
